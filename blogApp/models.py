...
class Post(models.Model):
    ...
    autor=models.ForeignKey(User, on_delete=models.CASCADE)#relacion uno a muchos, un usuario puede hacer varios post pero un mismo post no puede ser de varios usuarios.CASCADE, cuando el user se elimina, tambien se eliminan los post.
